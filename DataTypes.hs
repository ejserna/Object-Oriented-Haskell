...
data Operation = 
        ...
        | BOUNDS
        | ADD_INDEX
        | ACCESS_INDEX -- ACCESS_INDEX (2002) _ ADDRESS
        | PUT_INDEX -- PUT_INDEX ADDRESS_VALOR _ (2002) 
        -- (2002 es un valor que contiene el acceso al índice en cuestión)   
      deriving(Eq)
