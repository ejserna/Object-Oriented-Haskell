...
default:
	...
	ghc -o ObjectiveOrientedHaskell DataTypes.hs CodeGen/ExpressionOptimizer.hs Analysis/SymbolTable.hs Analysis/Expression.hs Analysis/ClassSymbolTable.hs CodeGen/Quadruple.hs CodeGen/CodeGen.hs Analysis/TypeChecker.hs Analysis/Scanner.hs Analysis/Parser.hs
