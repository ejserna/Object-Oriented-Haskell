...
genQuadrupleArithmetic symTab constMap idMap varCounters quadNum exp1 exp2 op = let typeExp1 = (expressionProcess (-100000000000000) exp1 symTab (Map.empty))
                                                                                ...
                                                                                in if (typeExp2 == typeExp1) then
                                                                                    ...
                                                                                    else ((intLitCUpdate2, decLitCUpdate2 + 1, strLitCUpdate2, boolLitCUpdate2), quad1 ++ quad2 ++ [(buildQuadrupleThreeAddresses quadNum2 op (decLitCUpdate - 1, decLitCUpdate2 - 1, (decLitCUpdate2)))], quadNum2 + 1)
...
genQuadrupleRelational symTab constMap idMap varCounters quadNum exp1 exp2 op = let typeExp1 = (expressionProcess (-100000000000000) exp1 symTab (Map.empty))
                                                                                ...
                                                                                in if (typeExp2 == typeExp1) then
                                                                                    ...
                                                                                    else ((intLitCUpdate2, decLitCUpdate2, strLitCUpdate2, boolLitCUpdate2 + 1), quad1 ++ quad2 ++ [(buildQuadrupleThreeAddresses quadNum2 op (decLitCUpdate - 1, decLitCUpdate2 - 1, boolLitCUpdate2))], quadNum2 + 1)
